...
def registerPlayer(address, firstbracket, connection, ncversion):
    try:
        ...
        return [True, '{"Message":"Connection validated", "!!VoscriptPluginData":["PopupWindow(Welcome to the official TFSMP server hosted by OptikLink.com - Please remember to be civilized and not annoy others!,Close)"]}']
    except BaseException as e:
